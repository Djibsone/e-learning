    ...
    if($password != $password2){
     ...
     if(empty($error_array)){
      ...
      $phone = 0122471214;
       ...
       $query = mysqli_query($con, "INSERT INTO users(first_name,last_name,username,email,password,profilePic,signup_date,user_closed,num_posts,phoneNumber,bio) VALUES ('$fname', '$lname', '$username', '$em', '$password', '$profile_pic', '$date','no','0','$phone','0')");
