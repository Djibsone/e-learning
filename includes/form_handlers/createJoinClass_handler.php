...
$user2= "";
	...
	if(isset($_POST['createClass_button'])){
		...
		if(($cName != "") && ($sec != "") && ($sub != "")){
			$query = mysqli_query($con, "INSERT INTO createclass(username,className,section,subject,courseCode,date,num_posts,student_array) VALUES('$username1', '$cName', '$sec','$sub', '$code', '$date1', '0', 'je suis' )");
		}
